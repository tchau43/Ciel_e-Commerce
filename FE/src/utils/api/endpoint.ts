...
export const API_ENDPOINTS = {
  ...
  USER_BY_ID: (id: string) => `${VITE_API_VERSION}/user/${id}`, 
  USER_PROFILE_UPDATE: `${VITE_API_VERSION}/user/profile`, 
  USER_CHANGE_PASSWORD: `${VITE_API_VERSION}/user/change-password`, 
  ...
  PRODUCTS_BY_SEARCH_NAME: `${VITE_API_VERSION}/product/searchName`, 
  ...
  CHAT_HISTORY_BY_THREAD: (threadId: string) =>
    `${VITE_API_VERSION}/chat/history/${threadId}`,

  
  ADMIN_USERS: `${VITE_API_VERSION}/admin/users`, 
  ADMIN_UPDATE_USER: (id: string) =>
    `${VITE_API_VERSION}/admin/updateUserById/${id}`, 
  ...
  DELIVERY: {
    CALCULATE_FEE: `${VITE_API_VERSION}/delivery/calculate`, 
  },
};

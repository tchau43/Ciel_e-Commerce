    ...
    <div className="p-10">
            ...
            <div className="relative overflow-hidden rounded-lg aspect-[5/4] ">
              ...
              >
                ...
                <div className="flex items-center justify-center">
                  <div
                    className="absolute top-4/5 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center 
                             bg-gradient-to-br bg-black w-4/5 py-2 rounded-lg"
                  >
      ...
      <div className="flex justify-between w-full gap-x-5">
        {homePageData?.features.map((f) => (
          <div className="flex flex-col items-center w-[2/7] gap-y-3">
            <img src={f.image_url}></img>
